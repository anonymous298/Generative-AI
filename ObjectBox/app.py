...
st.title('Object Box VectorDB Using Langchain and Groq')
    ...
    def initializeVectorDB():
        if 'vectordb' not in st.session_state:
            try:
                ...
                st.session_state.vectordb = ObjectBox.from_documents(documents=st.session_state.final_documents, embedding=st.session_state.embeddings, embedding_dimensions=768)
